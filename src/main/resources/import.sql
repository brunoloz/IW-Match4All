...
INSERT INTO competicion (id, nombre, tipo, capacidad, estado, equipos_por_grupo, equipos_clasifican_arbol) 
SELECT id, nombre, tipo, capacidad, estado, equiposPorGrupo, equiposClasificanArbol FROM CSVREAD('classpath:competicion.csv');
